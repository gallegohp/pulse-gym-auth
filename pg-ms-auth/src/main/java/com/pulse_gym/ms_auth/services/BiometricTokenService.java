...
public class BiometricTokenService {
    ...
    public String generateToken(Long userId, String deviceId) {
        ...
        // Generar hash del deviceId (solo por seguridad, aunque no se almacena en el token)
        ...
        return Jwts.builder()
                .claim("userId", userId)
                .claim("deviceId", deviceId) // Se guarda el deviceId plano, pero el microservicio de operaciones lo hasheará al comparar
                .issuedAt(now)
